...
<SwiperSlide>
  ...
  >
    ...
    <div className="relative p-5 z-10  max-w-lg">
      <h3 className="text-2xl font-bold text-white mb-4">We’ve Delivered Over 200 Surgeries!</h3>
      <p>
...
<SwiperSlide>
  ...
  >
    ...
    <div className="relative p-5 z-10 max-w-lg">
      ...
      <button className='primary btn-outline italic mt-4'>Book  Appointment </button>
    </div>
  </div>
</SwiperSlide>
      </Swiper>
